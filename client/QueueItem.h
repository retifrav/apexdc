...
class QueueItem : public Flags, public FastAlloc<QueueItem>, public PluginEntity<QueueData>, public intrusive_ptr_base<QueueItem> {
public:
	...
	static uint8_t getMaxSegments(int64_t fileSize);
