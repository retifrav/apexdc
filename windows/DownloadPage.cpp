...
PropPage::TextItem DownloadPage::texts[] = {
	...
	{ IDC_SETTINGS_RESET_LISTS, ResourceManager::SETTINGS_RESET_HUB_LISTS },
...
LRESULT DownloadPage::onClickedResetList(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/) {
	if (::MessageBox(m_hWnd, CTSTRING(SETTINGS_RESET_HUB_LISTS_CONFIRM), CTSTRING(SETTINGS_RESET_HUB_LISTS), MB_ICONINFORMATION | MB_YESNO) == IDYES)
