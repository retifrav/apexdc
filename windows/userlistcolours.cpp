...
PropPage::TextItem UserListColours::texts[] = {
	...
	{ IDC_ICONS_MODE, ResourceManager::ICONS_MODE },
...
LRESULT UserListColours::onInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
	...
	n_lsbList.AddString(CTSTRING(COLOR_PROTECTED));
	...
	iconsMode.Attach(GetDlgItem(IDC_OLD_ICONS_MODE));
	iconsMode.AddString(CTSTRING(DEFAULT));
	iconsMode.AddString(_T("Zion++ (> 2.16)"));
	iconsMode.AddString(_T("StrongDC++ (1.x)"));
	iconsMode.AddString(_T("DC++"));
	iconsMode.SetCurSel(SETTING(OLD_ICONS_MODE));
...
LRESULT UserListColours::onChangeColour(WORD /*wNotifyCode*/, WORD /*wID*/, HWND hWndCtl, BOOL& /*bHandled*/) {
	...
	switch(index) {
		...
		case 7: colour = protectedColour; break;
		case 8: colour = pasiveColour; break;
		case 9: colour = fullCheckedColour; break;
		case 10: colour = badClientColour; break;
		case 11: colour = badFilelistColour; break;
		default: break;
	}
	...
	if (d.DoModal() == IDOK) {
		switch(index) {
			...
			case 7: protectedColour = d.GetColor(); break;
			case 8: pasiveColour = d.GetColor(); break;
			case 9: fullCheckedColour = d.GetColor(); break;
			case 10: badClientColour = d.GetColor(); break;
			case 11: badFilelistColour = d.GetColor(); break;
			default: break;
		}
		refreshPreview();
	}
...
void UserListColours::write() {
	...
	SettingsManager::getInstance()->set(SettingsManager::PROTECTED_COLOUR, protectedColour);
	...
	SettingsManager::getInstance()->set(SettingsManager::OLD_ICONS_MODE, iconsMode.GetCurSel());
	iconsMode.Detach();
